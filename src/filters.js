...
export default class Filters extends React.Component {
    constructor(props) {
        ...
        if (this.state.originality[0] === true) {
            this.state.originality_filters = false;
        } else {
            this.state.originality_filters = true;
        }
        if (this.state.completion_status[0] === true) {
            this.state.completion_status_filters = false;
        } else {
            this.state.completion_status_filters = true;
        }
        if (this.state.era[0] === true) {
            this.state.era_filters = false;
        } else {
            this.state.era_filters = true;
        }
        if (this.state.type[0] === true) {
            this.state.type_filters = false;
        } else {
            this.state.type_filters = true;
        }
