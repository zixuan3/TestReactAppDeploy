...
const ORIGINALITY_NAMES = ['全部', '原创', '衍生'];
const COMPLETION_STATUS_NAMES = ['全部', '完结', '连载'];
const PUBLICATION_STATUS_NAMES = ['全部','简体出版','繁体海外出版','尚未出版'];
const ERA_NAMES = ['全部','近代现代','古色古香','架空历史','幻想未来'];
const TYPE_NAMES = ['全部','爱情','武侠','奇幻','仙侠','游戏','传奇','科幻','惊悚','悬疑','剧情','轻小说','古典衍生','东方衍生','西方衍生','其他衍生'];
const STYLE_NAMES = ['全部','悲剧','正剧','轻松','搞笑','暗黑'];
const CONTENT_LABELS_NAMES = ['全部','甜文','爽文','情有独钟','穿书','穿越时空','强强','娱乐圈','重生','豪门世家','快穿','系统','天之骄子','天作之合','种田文','都市情缘','仙侠修真','灵异神怪','无限流','宫廷侯爵','幻想空间','打脸','业界精英','励志人生','综漫','校园','年代文','女配','星际','女强','破镜重圆','欢喜冤家','文野','年下','竞技','悬疑推理','少年漫','直播','美食','异能','升级流','现代架空','未来架空','游戏网游','生子','三教九流','江湖恩怨','清穿','基建','恐怖','复仇虐渣','成长','时代奇缘','婚恋','逆袭','青梅竹马','相爱相杀','奇幻魔幻','西幻','都市异闻','花季雨季','机甲','前世今生','末世','科幻','东方玄幻','异想天开','古穿今','历史衍生','异世大陆','玄学','英美衍生','宫斗','时代新风','近水楼台','随身空间','灵魂转换','制服情缘','虐恋情深','传奇','布衣生活','超级英雄','家教','西方罗曼','女扮男装','爱情战争','宅斗','民国旧影','古典名著','武侠','红楼梦','乔装改扮','火影','异闻传说','科举','姐弟恋','阴差阳错','网王','猎人','七五','西方名著','职场','洪荒','齐神','性别转换','边缘恋歌','血族','异国奇缘','骑士与剑','封神','美娱','海贼王','死神','乡村爱情','圣斗士'];
...
export default class MainLayout extends React.Component {
    constructor(props) {
        ...
        if (this.props.location.aboutProps) {
            this.state = {
                originality: this.props.location.aboutProps.originality,
                originality_names: ORIGINALITY_NAMES,
                completion_status: this.props.location.aboutProps.completion_status,
                completion_status_names: COMPLETION_STATUS_NAMES,
                publication_status: one_true_x_false(3),
                publication_status_names: PUBLICATION_STATUS_NAMES,
                era: this.props.location.aboutProps.era,
                era_names: ERA_NAMES,
                ...
                content_labels_names: CONTENT_LABELS_NAMES,
                word_count: 0,
                rating: 0,
                rating_count: 0,
